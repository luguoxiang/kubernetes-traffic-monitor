...
func (manager *K8sResourceManager) WatchServices(stopper chan struct{}, handlers ...ServiceEventHandler) {
	watchlist := cache.NewListWatchFromClient(
		manager.clientSet.CoreV1().RESTClient(), "services", "",
		fields.Everything())
